...
public partial class ProductCleanArchDbContext : DbContext
{
    public ProductCleanArchDbContext()
    {
    }

    public ProductCleanArchDbContext(DbContextOptions<ProductCleanArchDbContext> options)
        : base(options)
    {
    }
